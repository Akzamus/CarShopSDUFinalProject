    ...
    <section class="products" id="products">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <div class="image">
                    <img src="../img/bmw%20s1000rr.jpg" width="300px">
                    <div class="icons">
            ...
            <div class="box">
                ...
                <div class="image">
                    <img src="../img/Bugatti%20La%20Voiture%20Noire.jpg"  width="300px">
                    <div class="icons">
            ...
            <div class="box">
                <div class="image">
                    <img src="../img/McLaren%20720s%20Spider.jpg" width="300px">
                    <div class="icons">
            ...
            <div class="box">
                <div class="image">
                    <img src="../img/Harley%20Davidson%20Cosmic%20Starship.jpg" width="400px">
                    <div class="icons">
            ...
            <div class="box">
                <div class="image">
                    <img src="../img/Ecosse%20Founder%20is%20Edition%20Ti%20XX.jpg" width="400px">
                    <div class="icons">
            ...
            <div class="box">
                <div class="image">
                    <img src="../img/Rolls-Royce%20Silver%20Spur.jpg"  width="450px">
                    <div class="icons">
            ...
            <div class="box">
                ...
                <div class="image">
                    <img src="../img/Chevrolet%2067.jpg"  width="450px">
                    <div class="icons">
