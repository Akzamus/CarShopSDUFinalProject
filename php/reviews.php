    ...
    <div class="box-container">
        ...
        <div class="box">
            <div class="stars">
                <?php
                    for ($i = 0; $i < 5; $i++)
                        echo '<i class="star"><img src="../img/yellow%20star.png" alt="star" height="28px" width="28px"></i>';
                ?>
            </div>
            ...
            <div class="user">
                <img src="../img/customer%201.jpg" alt="">
                <div class="user-info">
        ...
        <div class="box">
            ...
            <div class="user">
                <img src="../img/customer%202.jpeg" alt="">
                <div class="user-info">
                    <h3>John Snow</h3>
        ...
        <div class="box">
            ...
            <div class="user">
                <img src="../img/customer%203.jpg" alt="">
                <div class="user-info">
                    <h3>Lara Croft</h3>
        ...
        <div class="box">
            <div class="stars">
                <i class="star"><img src="../img/yellow%20star.png" alt="star" height="28px" width="28px"></i>
                <?php
                    for ($i = 0; $i < 4; $i++)
                        echo '<i class="star"><img src="../img/star.png" alt="star" height="25px" width="25px"></i>';
                ?>
            </div>
            <p>I was upset that they didn’t sell horses here, they slipped some kind of iron donkey on two wheels.
                ...
                scammed.</p>
            <div class="user">
                <img src="../img/customer%204.jpg" alt="">
                <div class="user-info">
        ...
        <div class="box">
            ...
            <div class="user">
                <img src="../img/customer%205.jpg" alt="">
                <div class="user-info">
        ...
        <div class="box">
            <div class="stars">
                <?php
                    for ($i = 0; $i < 4; $i++)
                        echo '<i class="star"><img src="../img/yellow%20star.png" alt="star" height="28px" width="28px"></i>';
                ?>
                <i class="star"><img src="../img/star.png" alt="star" height="25px" width="25px"></i>
            </div>
            ...
            <div class="user">
                <img src="../img/customer%206.jpg" alt="">
                <div class="user-info">
                    <h3>Ada Wong</h3>
        ...
        <div class="box">
            ...
            <div class="user">
                <img src="../img/customer%207.jpg" alt="">
                <div class="user-info">
                    <h3>Dante</h3>
