    ...
    <div class="box-container">
        ...
        <div class="box">
            <div class="stars">
                <?php
                    for ($i = 0; $i < 5; $i++)
                        echo '<i class="star"><img src="../img/yellow star.png" alt="star" height="28px" width="28px"></i>';
                ?>
            </div>
        ...
        <div class="box">
            ...
            <div class="user">
                <img src="../img/customer 2.jpeg" alt="">
                <div class="user-info">
                    <h3>John Snow</h3>
        ...
        <div class="box">
            <div class="stars">
                <i class="star"><img src="../img/yellow star.png" alt="star" height="28px" width="28px"></i>
                <?php
                    for ($i = 0; $i < 4; $i++)
            ...
            <p>I was upset that they didn’t sell horses here, they slipped some kind of iron donkey on two wheels.
                ...
                scammed.</p>
            <div class="user">
                <img src="../img/customer 4.jpg" alt="">
                <div class="user-info">
        ...
        <div class="box">
            ...
            <div class="user">
                <img src="../img/customer 5.jpg" alt="">
                <div class="user-info">
        ...
        <div class="box">
            ...
            <div class="user">
                <img src="../img/customer 6.jpg" alt="">
                <div class="user-info">
                    <h3>Ada Wong</h3>
        ...
        <div class="box">
            ...
            <div class="user">
                <img src="../img/customer 7.jpg" alt="">
                <div class="user-info">
                    <h3>Dante</h3>
